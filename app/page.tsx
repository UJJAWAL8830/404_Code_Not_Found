    ...
    <main className="min-h-screen flex flex-col items-center justify-center bg-black text-primary font-mono relative overflow-hidden selection:bg-primary selection:text-black">
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 md:gap-4 relative">
          ...
          >
            <span className="text-5xl md:text-7xl font-bold">&gt;_</span>
          </motion.div>

          <h1 className="text-4xl md:text-7xl pr-6 font-black tracking-tighter text-[#39FF14] drop-shadow-[0_0_15px_rgba(57,255,20,0.5)]">
            DEVSTORY
          </h1>
        </div>
        ...
        <div className="space-y-4">
          <p className="text-l md:text-xl text-muted-foreground/80 tracking-wide">
          ...
          <motion.p
            ...
            className="text-l md:text-xl text-primary font-bold tracking-wider"
          >
